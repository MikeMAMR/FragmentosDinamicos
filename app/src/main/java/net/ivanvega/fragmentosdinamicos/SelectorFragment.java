                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    switch (i){
                                        ...
                                        case 1:
                                            ...
                                            Snackbar.make(container, "Libro insertado", Snackbar.LENGTH_INDEFINITE)
                                        ...
                                        case 2:
                                            Snackbar.make(container, "Estas seguro?", Snackbar.LENGTH_LONG).setAction("Si", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View view) {
